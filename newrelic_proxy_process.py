...
if __name__ == '__main__':
  ...
  docker_site_entries = proxy_databag['staging']['docker']['apps']

  site_entries = prod_site_entries.copy()
  site_entries.update(docker_site_entries)
  ...
  for site_url, entry in site_entries.items():
