...
PRIVATEIP=$(knife search node "chef_environment:$CHEF_ENVIRONMENT AND $COOKBOOK_NAME:action" --config /var/jenkins_home/workspace/jenkins-chef-client/.chef/knife.rb | sed -n '4p' | awk '{print $2}')
